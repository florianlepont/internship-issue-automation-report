...
Nao est un robot humanoïde de 58cm de hauteur. Il trouve un public principalement dans les laboratoires de recherche et pour l'éducation (allant des écoles primaires aux universités). Trois versions du robot se sont succédées: 
\begin{itemize}
	\item *nom-d'environnement*
\end{itemize}
