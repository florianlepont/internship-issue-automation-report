...
\newline
\newline
Une fois les diverses méthodes algorithmiques comparées et un choix etabli, j'ai mis en place l'architecture fonctionnelle de notre système d'automatisation 