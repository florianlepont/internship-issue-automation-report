...
\subsection{Parallèle avec l'exemple de la prévision saisonnière et mise  en avantdu problème de l'évolution temporelle }
...
Si on fait le parallèle avec les exemples de la prévision saisonnière utilisés en 
