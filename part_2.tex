...
La première ligne correspond aux features, ce sont les mêmes features que l'ont retrouve dans le contenu d'un fichier log (\ref{Automatisation du processus d'investigation: Achitecture High Level du système proposé: Structure du fichier log}). Chaque ligne de se tableau constitue un exemple. Chaque donnée composant la base de donnée est donc structurée en features et en exemples. Chaque exemple 
