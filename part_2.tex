...
\begin{figure}[h]
	...
	\caption[Formes caractéristiques de BaseAccZ en temps normal et en cas de chute]{Considérer chaque unité de temps comme une feature: exemple. On souhaite dans cet exemple entraîner l'algorithme à reconnaitre le .}
