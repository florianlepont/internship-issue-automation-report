...
Avec : 
\begin{itemize}
	\item TP = True positive (en français vrais positifs)
	\item TN = True negative (en français vrais négatifs)
	\item FP = False positive (en français faux positifs)
	\item FN = False negative ( en français faux négatifs)
\end{itemize}
\\
