...
Par exemple, on souhaite créer une nouvelle couche root cause (i.e. entraîner un algorithme d'apprentissage) à reconnaitre le frottement des freins de la hanche, qui cause la chute du robot lors le Filtering Test. Pour cela on va s'intéresser plus particulièrement à courbe de 
