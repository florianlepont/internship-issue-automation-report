...
\thispagestyle{fancy}
Lorsqu'une error name (partie ) durant le Filtering test, de nombreuses données du robot sont enregistrées dans un fichier journal (que l'on retrouve plus souvent sous le terme anglais de fichier "log".) Une analyse poussée de ces données peut nous permettre de 
