...
La première ligne correspond aux features qui structurent la base de données. Ce sont les mêmes features que l'ont retrouve dans le contenu d'un fichier log (c.f. partie )
