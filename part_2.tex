...
La première ligne correspond aux features, qui sont les mêmes élements structurant que l'ont retrouve dans le contenu d'un fichier log (\ref{Automatisation du processus d'investigation: Achitecture High Level du système proposé: Structure du fichier log}). Chaque ligne de se tableau représente un exemple. Chaque exemple est composé des features contenues dans un fichier log en particulier, ce qui signifie que chaque exemple correspond en réalité à un fichier log et donc  
