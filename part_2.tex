...
\paragraph{Exemple} On souhaite créer une nouvelle couche root cause (i.e. entraîner un algorithme d'apprentissage) capable de reconnaitre lorsqu'un robot chute. Dans le cadre de notre problématique, ce système n'a pas de réelle utilité, on le propose ici 
