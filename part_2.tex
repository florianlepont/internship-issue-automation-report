...
\begin{description}
	...
	\item [couche error name] La couche error name est constitué d'un ensemble de couches error name de telle manière que lorsqu'un fichier historique est mis en entrée du système, 
\end{description} 
