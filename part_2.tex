...
Le modèle d'apprentissage utilisé le Support Vector Machine (SVM) avec l'utilisation de Kernels (c.f. présentation de l'algorithme partie \ref{Le Machine Learning: Les différents algorithmes: SVM}).
...
\section{Solutions proposées au problème de l'évolution temporelle des données}
\label{Automatisation du processus d'investigation: Solutions proposées au problème de l'évolution temporelle des données}

\subsection{Création de nouvelles features}
\label{Automatisation du processus d'investigation: Solutions proposées au problème de l'évolution temporelle des données: Création de nouvelles features}
% Revient à proposer une solution déterministe

\subsection{Passage des données dans le domaine fréquentiel}
\label{Automatisation du processus d'investigation: Solutions proposées au problème de l'évolution temporelle des données: Passage des données dans le domaine fréquentiel}

\subsection{Calcul de la convolution}
\label{Automatisation du processus d'investigation: Solutions proposées au problème de l'évolution temporelle des données: Calcul de la convolution}

\section{La reconnaissance de motifs}
\label{Automatisation du processus d'investigation: La reconnaissance de motifs}

\section{Étendre le problème à plusieurs dimensions }
\label{Automatisation du processus d'investigation: La reconnaissance de motifs}

\section{Difficultées notoires rencontrées}
\label{Automatisation du processus d'investigation: La reconnaissance de motifs}