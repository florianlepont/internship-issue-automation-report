...
Les exemples sont les éléments permettant d'entraîner l'algorithme d'apprentissage automatique (c.f. partie \ref{Le Machine Learning: Généralités sur le Machine Learning: Les données}). Dans le cadre de la résolution de notre problématique, chaque exemple est généré lorsqu'une erreur est détectée (error name) durant le déroulement du Filtering Test. Il s'agit du fichier log. 
