...
De manière intuitive: Chaque root cause peut être associé à deux formes particulière caractéristique: une forme correspondant à  cela revient à apprendre la forme globale et caractéristique d'une feature en cas de présence ou non d'une root cause. Une fois cette forme apprise, on la compare avec la forme que l'on souhaite analyser afin de savoir si la root cause est présente ou non dans  
