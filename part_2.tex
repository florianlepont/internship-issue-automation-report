...
L'évolution temporelle des exemples utilisés pour l'entraînement de l'algorithme implique de prétraiter les données (c.f. partie ). Pour cela, différentes approches sont envisagées.
