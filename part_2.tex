...
\paragraph{Exemple de mise en place  } On présente un exemple type d'analyse d'un fichier log afin de présenter quel est le rôle de chacune des couches dans la phase d'investigation.
