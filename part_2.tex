...
Avec : 
\begin{itemize}
	\item TP = True positive (en français vrai positif)
	\item TN = True negative (en français vrai négatif)
	\item FP = False positive (en français faux positif)
	\item FN = False negative ( en français faux négatif)
\end{itemize}
