...
Si on fait le parallèle avec les exemples de l'exemple "prévision saisonnière" (c.f. partie \ref{Le Machine Learning: Généralités sur le Machine Learning: Les données: Différents types d'exemples})
