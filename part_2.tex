...
Chaque échantillon qui compose le motif caractéristique d'une \emph{root cause}, contenu dans un exemple (e.g. "HipPitchPositionSensorValue") devient donc une feature (i.e. une entrée) du système d'apprentissage de l'algorithme SVM \ref{fig:Créer un patron caractéristique de la chute du robot}). Dans le cas d'
