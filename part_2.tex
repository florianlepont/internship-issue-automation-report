...
On présente dans cette partie les différentes solutions testées afin de contourner le problème causé par l'évolution temporelle de nos exemples utilisés pour entraîner le SVM.
...
On propose dans un premier temps de créer de nouvelles features à partir des features 
