...
Une fois nos différentes couches root cause crées, on souhaite utiliser notre système pour détecter la cause de la chute d'un robot (c.f. figure \ref{fig:utilisation de la couche error name}). Pour cela, 
