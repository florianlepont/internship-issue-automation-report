...
Chaque échantillon qui compose le motif caractéristique contenu dans un exemple (e.g. "HipPitchPositionSensorValue") devient donc une feature (i.e. une entrée) de notre système d'apprentissage de l'algorithme SVM, afin de contourner le problème causé par l'évolution temporelle des données (cf. schéma \ref{fig:Créer un patron caractéristique de la chute du robot}). Dans le cas d
