...
\begin{itemize}
	\item Si la distance entre les deux courbes est importante à la fin du graphe, cela signifie que l'on a pas assez d'exemples pour l'entraînement de l'algorithme. On dit que l'algorithme a une \emph{variance} trop élevée. 
