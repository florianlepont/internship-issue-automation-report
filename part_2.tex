...
Lorsque l'on souhaite investiguer un fichier pour déterminer la \emph{root cause} ayant entrainé l'apparition de l'\emph{error name} durant le Filering Test, on extrait la valeurs des features du fichier log liées à la \emph{root cause} et on parcours la courbe à la recherche du motif caractéristique 
