...
Le problème est qu'on peut réaliser de l'apprentissage supervisé uniquement avec des données discrètes. Sous leurs formes actuelles, les données de nos exemples ne peuvent donc pas servir à entrainer  
