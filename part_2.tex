...
\begin{figure}[h]
	...
	\caption[Synoptique haut niveau de la couche root cause]{Synoptique haut niveau des couches root cause. Les couches root cause correspondent à des algorithmes d'apprentissage automatique que l'ont entraîne à détecter la root cause à laquelle ils sont associés.}
