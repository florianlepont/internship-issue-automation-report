...
Le modèle d'apprentissage utilisé le Support Vector Machine (SVM) avec l'utilisation de Kernels (c.f. présentation de l'algorithme partie \ref{Le Machine Learning: Les différents algorithmes: SVM} et la comparaison des différents algorithmes partie ).
...
\section{Solutions  testées}
\label{Automatisation du processus d'investigation: Solutions testées}
