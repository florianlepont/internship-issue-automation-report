...
Chaque couche root cause peut être donc considéré comme un système à part entière. Le schéma fonctionnel d'une root cause (c.f. figure) reprend la même structure que celui du Machine Learning (c.f. \ref{fig:Schéma fonctionnel haut niveau du Machine Learning})
