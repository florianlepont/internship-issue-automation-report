...
Un schéma synoptique illustrant le fonctionnement systémique de notre architecture High Level est proposé figure \ref{fig:Schéma synoptique haut niveau de la solution proposée: couche error name} et \ref{fig:Schéma synoptique haut niveau de la solution proposée: couche root cause}.
