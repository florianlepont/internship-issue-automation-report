...
\begin{figure}[h]
	...
	\caption[Créer un patron caractéristique d'une ]{Considérer chaque unité de temps comme une feature: exemple. On souhaite dans cet exemple entraîner l'algorithme à reconnaitre le .}
