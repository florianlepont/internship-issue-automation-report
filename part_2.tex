...
Pour savoir si le robot chute ou non, on analyse l'évolution de la valeur de l'accélération selon l'axe $z$, fournit par l'accéléromètre de la base de Pepper. L'accélération selon l'axe $z$ est donc la feature de notre système (clé BaseAccZ). D'après la figure ..., on remarque que la valeur de BaseAccZ enregistrée lors de la chute d'un robot diffère de celle. On va entraîner à l'algorithme à reconnaitre la forme caractéristique de l'évolution de l'accélération en $z$ du robot lorsque le robot chute. \\
Une fois la forme caractéristique d'une chute apprise
