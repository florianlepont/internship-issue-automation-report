...
On propose de créer de nouvelles features, constantes, caractéristiques des features actuelles. On peut par exemple calculer la moyenne d'une feature, sa valeur crête-à-crête, sa valeur maximum, etc. On se sert ensuite de ces nouvelles features pour réaliser l'entrainement de notre algorithme. Par exemple, la feature "BaseAccZ" de l'exemple présenté en figure ...  représente l'évolution de l'accélération du robot selon l'axe Z lorsque le robot chute. 

Le problème de cette approche est qu'elle réduit le nombre d'informations que contient une donnée à seulement quelques caractéristiques. Comme le démontre la figure ..., cette diminution des informations peut entrainer des risques de confusions entre les différentes features. 
