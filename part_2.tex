...
Le modèle d'apprentissage utilisé le Support Vector Machine (SVM) avec l'utilisation de Kernels (c.f. \ref{Le Machine Learning: Les différents algorithmes: SVM} présentation de l'algorithme partie )
