...
\label{Automatisation du processus d'investigation: Solutions proposées au problème de l'évolution temporelle des données: Différentes approches étudiées}

\subsubsection{Création de nouvelles features}
\label{Automatisation du processus d'investigation: Solutions proposées au problème de l'évolution temporelle des données: Différentes approches étudiées: Création de nouvelles features}
...
\label{Automatisation du processus d'investigation: Solutions proposées au problème de l'évolution temporelle des données: Différentes approches étudiées: Passage des données dans le domaine fréquentiel}

\subsubsection{Calcul de la convolution}
\label{Automatisation du processus d'investigation: Solutions proposées au problème de l'évolution temporelle des données: Différentes approches étudiées: Calcul de la convolution}
