...
Par exemple, on souhaite créer une nouvelle couche root cause (i.e. entraîner un algorithme d'apprentissage) à reconnaitre le frottement des freins de la hanche, entraînant la chute du robot durant le Filtering Test. Pour cela on va s'interesser plus particulièrement à la courbe de 
