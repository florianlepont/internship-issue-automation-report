...
On souhaite dans un premier temps mettre en place l'architecture permettant de détecter la cause (root cause) ayant entrainé la chute du robot lors du Filtering test (error name). Cette étape consiste à créer les couches root cause, i.e. entrainer différents algorithmes d'apprentissages à reconnaitre la root cause pour laquelle ils ont été crée (figure 	\label{fig:synoptique haut niveau de la solution proposée: couche root cause} )
