...
Pour savoir si le robot chute ou non, on analyse l'évolution de la valeur de l'accélération selon l'axe $z$, fournit par l'accéléromètre de la base de Pepper. L'accélération selon l'axe $z$ est donc la feature de notre système (clé BaseAccZ). D'après la figure ..., on remarque que la feature BaseAccZ enregistrée lors de la chute d'un robot et celle lorsqu'il n'y a pas eu de chutes ont toute deux des formes différentes. On va entraîner à l'algorithme à reconnaitre la forme caractéristique de l'évolution de l'accélération en $z$ du robot lorsque le robot chute. \\
Une fois la forme apprise

 l'accélération en $z$ augmente instantanément
