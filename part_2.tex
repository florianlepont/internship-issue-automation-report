...
\subsection{Construction d'une couche root cause à partir de la base de données d'exemples}
\label{Automatisation du processus d'investigation: Achitecture High Level du système proposé: Construction d'une couche root cause à partir de la base de données d'exemples}

Si on fait le parallèle avec les exemples utilisés en 
