...
\paragraph{Exemple de mise en place  d'une couche error name et de ses couches root cause}.
Afin de présenter de manière plus concrète l'architecture  haut niveau de notre solution, on soumet un exemple. 
\begin{figure}[h]
