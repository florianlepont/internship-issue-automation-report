...
On propose de créer de nouvelles features, constantes, caractéristiques des features actuelles. On peut par exemple calculer la moyenne d'une feature, sa valeur crête-à-crête, sa valeur maximum, etc. On se sert ensuite de ces nouvelles features pour réaliser l'entrainement de notre algorithme. Par exemple, dans le cas de la feature "BaseAccZ" (correspondant à l'accélération selon l'axe Z retourné par l'accéléromètre de la base) de l'exemple figure ... , correspondant à la valeur retournée par 

Le problème de cette approche est qu'elle réduit le nombre d'informations que contient une donnée à seulement quelques caractéristiques.
