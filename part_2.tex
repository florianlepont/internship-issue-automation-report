...
\begin{equation}
	\begin{blockarray}{ccccccc}
		\begin{block}{c[cccccc]}
			features & \begin{tabular}HeadPitchPositionActuatorValue \end{tabular}&  \begin{tabular}HeadPitchElectricCurrentSensorValue \end{tabular} & \begin{tabular}HipPitchPositionActuatorValue \end{tabular} & \begin{tabular}HipPitchPositionActuatorValue \end{tabular} &   \begin{tabular}KneePitchPositionActuatorValue \end{tabular} & \begin{tabular}KneePitchPositionSensorValue \end{tabular}  \\
			...
			t_10 & -0,523 & 0,128 & -0,021 & -0,033 & -0,018 & -0,043 \\
			t_11 & -0,564 & 0,16 & -0,021 & -0,034 & -0,026 & -0,049 \\
			t_12 & -0,586 & 0,032 & -0,021 & -0,038 & -0,029 & -0,051 \\
			t_n & ... & ... & ... & ... & ... & ... \\
		\end{block}
	\end{blockarray}
