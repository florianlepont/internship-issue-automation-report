...
On propose dans un premier temps de créer de nouvelles features constantes, caractéristiques des features actuelles. On peut par exemple calculer la moyenne d'une feature, sa valeur crête-à-crête, sa valeur maximum, etc. 

Le problème de cette approche est qu'elle réduit le nombre d'informations contenues dans 
