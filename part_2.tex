...
Le fichier log de ce tableau correspond uniquement à un seul exemple de la base de données de fichiers qui nous sert pour entrainer chacun de nos algorithmes. 
