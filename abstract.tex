\begin{abstract}
\label{abstract}
Mon stage ingénieur, réalisé dans le cadre de ma cinquième année de formation à l'École Nationale d'Ingénieurs de Brest (ENIB), s’est déroulé au sein du département "Qualification Hadware Pepper (QWP) de l'entreprise Aldebaran, à Paris. La société s'est fait connaitre dans le monde des nouvelles technologie et de la robotique humanoïde grâce au développement de son premier produit: le robot "Nao". Celui-ci se destine dans un premier temps aux université et aux laboratoires de recherche. La société cherche aujourd'hui à étendre son marché aux entreprises et aux particuliers avec le développement d'un tout nouveau produit: "Pepper". 
