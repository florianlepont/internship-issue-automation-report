...
\subsubsection{Module Marchine Learning}
...
On présente ici les différents outils graphiques qui permettent de réaliser la construction d'une nouvelle couche root cause (i.e. un nouvel algorithme pour détecter une \emph{root cause}), d'investiguer un \emph{error name} et d'obtenir des informations sur les performances de l'algorithme. 
