...
\thispagestyle{fancy}
Une fois le processus fonctionnel de notre système défini, on l'industrialise. Cela signifie que l'on crée un ensemble d'outils qui permettent de l'utiliser de la manière la plus simple possible et cd en répondant au mieux à la problématique initiale. \\
