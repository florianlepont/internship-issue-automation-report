...
\begin{item}
	...
	- La dernière partie (encadré bleu de la figure  \ref{fig:Interface graphique du pattern selector}) est une succession de boutons permettant d'interagir avec les différents exemples. Le premier bouton "previous" permet de revenir à l'exemple précédent.
\end{item} 
