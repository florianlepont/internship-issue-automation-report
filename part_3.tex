...
Cette interface graphique permet de visualiser l'exemple que l'on investigue et la courbe de probabilité représentant la probabilité que le motif soit présent dans l'image. 
