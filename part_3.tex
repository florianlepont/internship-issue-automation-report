...
Au des valeurs obtenues, on déduit que l'algorithme sera plus performant lorsque la région de sélection est petite. Or, le but étant de sélectionner le plus précisément possible le motif caractéristique d'une root cause, il faut donc 