...
Il suffit pour cela d'indiquer le nom de la couche error name que l'on souhaite créer, dans notre case, on l'appellera \textbf{fall down}. Celle-ci ne contient à sa création aucune root cause.
...
Pour cela, on suit le processus décrit à la figure 
...
\begin{figure}[H]
	\centering\includegraphics[height=7cm]{images/invest_menu.png}
...
\begin{figure}[H]
	\centering\includegraphics[height=7cm]{images/perf_menu.png}
...
\begin{figure}[H]
	\centering\includegraphics[height=7cm]{images/update_menu.png}
