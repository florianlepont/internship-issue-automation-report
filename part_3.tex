...
On présente ici les différents outils graphiques permettant de réaliser la construction d'une couche root cause (i.e. l'entrainement d'un nouvel algorithme à la détection d'une root cause particulière), d'investiguer un error name 
