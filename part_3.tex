...
Le menu "Add a root cause to the knowledge base" (c.f. figure 	\ref{fig:Menu principal}) permet de créer une nouvelle root cause (i.e. entraîner un nouvel algorithme d'apprentissage à reconnaitre une root cause), à la lier 
