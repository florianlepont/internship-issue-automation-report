...
Il existe certains cas où les valeurs de deux features étudiées sont trop éloignées pour pouvoir être visualisé de manière correct. Pour cela, on peut basculer l'IHM en mode étendu, ce qui permet d'afficher 
