...
Le menu "Update a root cause  (c.f. figure \ref{fig:Menu principal}) permet d'ajouter des exemples à la base de données d'exemples d'une root cause déjà connue (i.e. enregistrée dans la base de données) et d'entrainer de nouveau l'algorithme d'apprentissage afin d'en améliorer les performances. 
