...
\begin{figure}[h]
	...
	\caption[Interface graphique du pattern selector]{Interface graphique du pattern selector. La première partie de l'interface (encadré vert) donne des informations sur }
