...
\subsubsection{Format des données en sortie du pré-traitement des données}
\label{Industrialisation du produit: Outils: API: Le module Machine Learningx}
Le module Machine Learning s'appuie sur l'utilisation de scikit-learn. Il s'agit d'une bibliothèque Open Source développée par l'INRIA 
