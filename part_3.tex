...
\begin{description}
	...
	\item [Tri des données] Enfin, afin de pouvoir mesure les performances de notre algorithme (c.f. partie \ref{Automatisation du processus d'investigation: Performances de la solution})
\end{description}
