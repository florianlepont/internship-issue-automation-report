...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Le bouton "Not Found" permet d'indiquer au système que le motif n'est pas présent sur l'exemple étudié. Cela revient à labelliser l'exemple (Y = 0, c.f. partie \ref{Industrialisation du produit: API: Format des données en sortie du pré-traitement}) 
...
La région de sélection permet de sélectionner le motif caractéristique d'une root cause dans chaque exemple où celui-ci est présent. Il est possible d'augmenter la taille de celui-ci si le besoin de 
