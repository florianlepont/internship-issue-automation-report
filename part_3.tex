...
\begin{figure}[h]
	\centering\includegraphics[height=7.4cm]{images/pattern_selector.png}
...
\begin{figure}[h]
	\centering\includegraphics[height=7.4cm]{images/pattern_selector_ext.png}
	\caption[Interface graphique du pattern selector en mode étendu]{Interface graphique du pattern selector en mode étendu.}
