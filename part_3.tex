...
On présente ici le format des données en sortie de chacune des étapes étudiées en partie \ref{Industrialisation du produit: Outils: API: Pré-traitement et traitement des données}
