...
\begin{enumerate}
		\item [Apprentissage]
		 \begin{enumerate}
			...
			\item A partir de ces informations, le système ($f$) apprend - s'entraîne- pour être en capacité de prendre une décision vis-à-vis de la tâche qui lui est demandé. 
		\end{enumerate}
