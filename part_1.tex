...
\label{Le Machine Learning: Les différents algorithmes: Comparaison des différentes méthodes}
Au regard de l'analyse des différentes méthodes d'apprentissages automatiques réalisées en partie \ref{Le Machine Learning:Les différents algorithmes d'apprentissage supervisé}, on propose de tester plusieurs de ces algorithmes et de choisir celui qui répondra le plus efficacement à notre problématique initiale, i.e. d'automatiser l'analyse des erreurs apparues lors du déroulement du Filtering Test.