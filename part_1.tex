...
\end{description}
 ...
 De nombreuses autres définitions existent pour définir ce qu'est le Machine Learning, mais celles-ci ne correspondent pas à l'aspect  qui nous intersse dans le cadre de ce projet
