...
\textit{On cherche ici à déterminer à quelle période de l'année nous nous trouvons (i.e. printemps, été, automne ou hiver).
	La première étape de notre processus sera donc d'entrainer notre algorithme afin que }
