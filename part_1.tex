...
\begin{description}
	\item [les features] Le type de données présenté en entrée. Dans le cas de notre exemple il s'agit de la température, la pression atmosphérique et l'humidité.
	...
	\item [La décision] La sortie ou réponse du système 
\end{description}
