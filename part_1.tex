...
On cherchera donc à minimiser la valeur de a fonction coût $J(\theta_0,\theta_1)$. Pour cela, on peut jouer su la valeur des paramètres $\theta_0$ et $\theta_1$ de l'hypothèse.
