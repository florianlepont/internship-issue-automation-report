...
\begin{table}[h]
	\begin{tabular}{ | p {2.5cm} | p {4cm} | p {4cm} |}
		...
		\hline
		Exemple 1  & blablabla & blobloblo \\
		\hline 
		Exemple 2 & blablabla  & blobloblo \\
		\hline
	\end{tabular}
	\caption[Comparaison de l'apprentissage supervisé et non supervisé via des exemples]{Comparaison des différentes méthodes d'apprentissage}
