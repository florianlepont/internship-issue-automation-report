...
Il est possible d'utiliser des hypothèses plus complexes. Par exemple, on a $h_\theta(x) = g(\thata_0+ \theta_1x_1 + \theta_2x_2 + \theta_1x_1^2 + \theta_1x_2^2)$ avec $\theta = \begin{blockarray}{[c]} -1 \\ 0 \\ 0 \\ 1 \\ 1 \end{blockarray}$
