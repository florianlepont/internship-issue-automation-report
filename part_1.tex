...
Les exemples de classification présentés jusqu'ici ne comportaient que deux classes, or il est possible de résoudre des problèmes dont la décision en sortie doit être effectuée entre plusieurs classes. Pour cela, on sépare les multiples classes en classes binaires. Soit l'exemple de la partie \ref{Le Machine Learning: Généralités sur le Machine Learning: Définition et principe général:un exemple concret}, on a en sortie une décision à prendre parmi les 4 classes printemps, été, automne et hiver. Pour résoudre ce problème, on compare une classe par rapport à l'ensemble des autres classes (considéré alors comme un seul et même ensemble homogène). Cette méthode s'appelle la "One-vs-All".
...
\begin{figure}[h]
	\centering\includegraphics[height=8cm]{images/svm_no_margin.png}
...
\begin{figure}[h]
	\centering\includegraphics[height=8cm]{images/svm_margin.png}
