...
\begin{itemize}
	...
	\item $x^i$ exemples de l'entrainement $i$
	\item $y^i$ sorties de l'entrainement $i$
\end{itemize}
...
Où $X_1$, $X_2$ et $X_3$ correspondent respectivement aux features surfacen nombre d'étages et nombre de pièces.
...
L'algorithme du gradient \eqref{gradient descent multivar} s'exprime donc: 
\begin{equation}
