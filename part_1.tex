...
\begin{enumerate}
		\item [Apprentissage]
		 \begin{enumerate}
			...
			\item A partir de ces informations, le système apprend - s'entraîne- afin d'être par la suite en capacité de prendre décision vis à vis de la tâche qui lui sera demandée. 
		\end{enumerate}
