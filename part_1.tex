...
On simplifie la formulation de la fonction coût:
\begin{equation}
J(\theta) = \frac{1}{m}\sum_{i=1}^{m}Cost(h_\theta,y)
\end{equation}

Avec $Cost(h_\theta,y)$ le terme de coût, que l'on remplace par sa nouvelle expression (afin d'introduire de la convexité):
\begin{equation}
...
Sous cette forme, l'hypothèse est convexe.
