...
\begin{table}[h]
	...
	\hline
	\backslashbox{Exemples}{Apprentissage} & supervisé & non supervisé \\
	\hline
	\begin{tabular}{c} n\degres1:\\l'apprentissage à l'Homme\end{tabular}  &
	 Une institutrice souhaite apprendre à ses élèves à différencier un chat d'un chien: c'est le type de décision qu'on attend d'eux. Pour ce faire, l'éducatrice leur montre différentes photos de chien et de chats: ce sont les exemples d'apprentissage. Ces exemples possèdent différentes caractéristiques comme la taille de l'animal, sa couleur, la longueur du poil, etc: il s'agit des features. Lorsque que l'institutrice leurs présente les différentes images, elle leur stipule clairement si il s'agit d'un chien ou d'un chat: il y'a donc une corrélation entre l'entrée et la sortie de l'apprentissage, il s'agit d'un apprentissage supervisé.&
	 blobloblo \\
	\hline 
	\begin{tabular}{c} n\degres2:\\exemple de la météo \ref*{Le Machine Learning: Généralités sur le Machine Learning: Définition et principe général:un exemple concret}\end{tabular} & blablabla  & blobloblo \\
	\hline
	\end{tabular}
