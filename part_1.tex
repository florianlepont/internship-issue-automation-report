...
\begin{table}[h]
	...
	\hline
	n\degres1  & blablabla & blobloblo \\
	\hline 
	n\degres2 & blablabla  & blobloblo \\
	\hline
	\end{tabular}
	\caption[Comparaison de l'apprentissage supervisé et non supervisé via des exemples]{Comparaison des différents modèles d'apprentissage}
