...
\label{Le Machine Learning: Généralités sur le Machine Learning: Le modèle:Regression et classification}
 La régression logistique est un type d'apprentissage avec lequel on essaie de prédire une sortie continue. 
 
La classification essaie quant à elle de prédire une sortie discrète. Elle peut être vu comme un cas particulier de la régression où les valeurs à prédire sont discrètes. 
