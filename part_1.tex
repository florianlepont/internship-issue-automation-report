...
\begin{table}[h]
	...
	\hline
	\backslashbox{}{} & apprentissage supervisé & apprentissage non supervisé \\
	\hline
	\begin{tabular}{c} exemple n\degres1:\\apprendre aux \\ humains \end{tabular}  &
	 ...
	 blobloblo \\
	\hline 
	\begin{tabular}{c} exemple n\degres2:\\exemple de la météo \ref*{Le Machine Learning: Généralités sur le Machine Learning: Définition et principe général:un exemple concret}\end{tabular} & blablabla  & blobloblo \\
	\hline
	\end{tabular}
