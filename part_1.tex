...
On a cette fois ci plusieurs entrées $X$ (surface, nombre de pièces, nombre d'étages). Soit le tableau \ref {tab:parc immobilier muli} les exemples $X$
\begin{table}[h]
	\begin{tabular}{ | p {4cm} | p {4cm} |}
		\hline
		taille ($m^2$) & prix (\euro) \\
		...
		\hline 
	\end{tabular}
	\caption[parc immobilier]{exemples du prix des logements en fonction de leur surface, du nombre d'étages et du nombre de pièces}
