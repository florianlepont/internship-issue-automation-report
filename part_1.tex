...
\subsubsection{La régression linéaire et classification}
\label{Le Machine Learning: Les différents algorithmes: La regression logistique}
...
Où $y = 0$ correspond à la période hiver et $y = 1$ la période été. 



Cette méthode fonctionne dans ce cas ci car les exemples sont régulièrement espacées entres elles. Si elles ne l'étaient pas, le seuil serait alors mal placé. La régression linéaire n'est donc pas adaptée pour la classification. 
