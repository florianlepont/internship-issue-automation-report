...
Cette méthode fonctionne dans ce cas ci car les exemples sont régulièrement espacées entres elles. Si elles ne l'étaient pas, le seuil serait alors mal placé. La régression linéaire n'est donc pas adapté pour la classification, on va donc l'adapter. 
