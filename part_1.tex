...
Pour reprendre l'exemple précédent \ref{Le Machine Learning: Généralités sur le Machine Learning: Définition et principe général:un exemple concret}, on aurait les jeux de données suivants: 
...
Exemple_3 & 23 & 65 & 1015 & été \\
... & ... & ... & ... \\
Exemple_n & 10 & 81 &  1032 & printemps\\
\end{block}
\end{blockarray}
\end{equation}
On connait la sortie qui correspond aux données d'entrée. 
...
\end{blockarray}
\end{equation}
On ne connait pas la sortie qui correspond aux données d'entrée. 
