...
\begin{figure}[h]
	...
	\caption[Exemple d'une régression logistique]{Exemple d'une regression logistique. Les données en jaune sont séparées des données vertes par la frontière de décision (ligne rouge sur le graphe).}
