...
\end{itemize}
C'est le comportement que l'on attend de la fonction coût, i.e. d'optimiser l'hypothèse de manière à ce que celle-ci s'approche de la valeur de sortie réelle.
