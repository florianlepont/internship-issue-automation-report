...
\begin{description}
	\item [les features] Le type de données présentées en entrée. Dans le cas de notre exemple il s'agit de la température, la pression atmosphérique et l'humidité.
	\item [échantillons ou exemples] Les données permettant d'entrainer le système (X_train).
	\item [le modèle d'apprentissage]
\end{description}
