...
\end{blockarray}
\end{equation}
On ne connait pas la sortie qui correspond aux données d'entrée, i.e. que on \emph{ne} sait à \emph{pas} quelle période de l'année les échantillons ont été prélevé. 
