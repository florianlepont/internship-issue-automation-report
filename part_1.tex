...
\begin{table}[h]
	...
	\hline 
	\begin{tabular}{c} n\degres2:\\exemple \ref*{Le Machine Learning: Généralités sur le Machine Learning: Définition et principe général:un exemple concret}\end{tabular} & blablabla  & blobloblo \\
	\hline
	\end{tabular}
