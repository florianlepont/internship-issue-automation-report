...
\begin{table}[h]
	\begin{tabular}{ | p {6cm} | p {6cm} |}
		...
		\hline
		On souhaite connaitre le temps (température et humidité) qu'il fera pendant les jours suivants. Pour cela, on s'appuie sur les différents échantillons de température et d'humidité des mois et années précédentes sachant que l'on connait 
		 & \\
		\hline 
