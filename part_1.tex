...
Il existe différents types de modèles. Le choix d'un type en particulier est influencé par le type d'exemples que l'on a en entrée du système et du type de sortie que l'on souhaite avoir en sortie. 
