...
\begin{figure}[h]
	\centering\includegraphics[height=4cm]{images/class_reg_lineaire.png}
	\caption[Classification via regression linéaire]{Classification via régression linéaire. On observe sur la figure a) que lorsque  }
