...
Le Support Vector Machine (traduire en français par "Machine à vecteurs de support") permet de résoudre des problèmes de classification. De manière conceptuelle, le SVM reprend les concepts de la régression logistique. Il y ajoute cependant deux notions supplémentaires:
\begin{description}
	\item [la marge maximale]
	\item [les fonctions noyaux].
\end{description}
