...
\begin{table}[h]
	...
	\begin{tabular}{c} exemple n\degres1:\\apprendre aux \\ humains \end{tabular}  &
	 \begin{tabular}{c} Une institutrice souhaite apprendre à ses élèves à différencier un chat d'un chien: c'est la décision qu'on attend d'eux. \\
	 	  Pour ce faire, l'éducatrice leur montre différentes photos de chiens et de chats: ce sont les exemples d'apprentissage. \\
	 	  Ces exemples possèdent différentes caractéristiques comme la taille de l'animal, sa couleur, la longueur du poil, etc: il s'agit des features. \\
	 	  Lorsque que l'institutrice leurs présente les différentes images, elle leur stipule clairement si il s'agit d'un chien ou d'un chat: il y'a donc une corrélation entre l'entrée et la sortie de l'apprentissage, il s'agit d'un apprentissage supervisé. \end{tabular}  &
	 blobloblo \\
	\hline 
