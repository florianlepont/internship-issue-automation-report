...
\begin{table}[h]
	\begin{tabular}{ | p {6cm} | p {6cm} |}
		...
		\hline
		On souhaite connaitre la température qu'il fera pendant les jours suivants. Pour cela, on s'appuie sur les différents échantillons de température des mois et années précédentes sachant que l'on connait 
		 & \\
		\hline 
