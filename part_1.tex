...
L'entrainement d'un algorithme de type SVM peut être effectué avec peu d'exemples. En effet, la marge maximale s'appuie sur les données en périphéries des ensembles homogènes. De plus, il s'agit d'un outils puissant et facilement adaptable.

\subsection{Périmètre d'utilisation de la régression logistique et du SVM}
