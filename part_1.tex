...
Le champ d'étude et d'application du Machine Learning étant immense, on propose de définir cette notion pour l'adapter à la résolution de notre problématique, c'est-à-dire d'automatiser l'analyse d'incidents 
