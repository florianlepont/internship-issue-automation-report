...
Dans le cadre d'une régression linéaire, la forme de l'hypothèse est linéaire. Dans le cas de la régression logistique, celle-ci ne l'est plus (forme sigmoïde). La forme de la fonction coût ne sera donc pas convexe (figure \ref{fig:Régression linéaire, calcul des paramètres de l'hypothèse}) 
