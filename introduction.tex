...
On présente ici de manière succincte l'architecture Hardware du robot Pepper afin de se familiariser avec les différents éléments du système que nous serons susceptible de rencontrer lors de la construction de ce projet.  
...
Le robot Pepper est constitué de 20 moteurs dont il est possible de contrôler la position et la rigidité.
\begin{description}
...
Les leds placés sur les épaules de Pepper et autour de ces yeux permettent d'obtenir un certain nombre d'informations sur l'état du robot.
