...
[{Chute du robot}, align=center, name=SS
	...
	[{courant dans les\\fusibles trop élevé}]
	[{Erreur sur la\\centrale intertielle}]
]
\node[anchor=west,align=left] 
at ([xshift=-2cm]PDC.west|-PDC) {Level 2\\ Group Criteria};
\node[anchor=west,align=left] 
at ([xshift=-2cm]PDC.west|-SS) {Level 1\\Overall Objective};
\end{forest}
