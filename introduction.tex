...
\begin{table}[h]
	\begin{tabular}{ | l | l | l |  l |}
		...
		\hline
		\multicolumn{4}{| l |}{Test 1 : succession de divers actions effectué 4 fois toute les heures } \\
		\hline
		...
		\hline
		\multicolumn{4}{| l |}{Test 12: enchainement de 8 danses répété 5 fois sur les dix heures} \\
		\hine
	\end{tabular}
