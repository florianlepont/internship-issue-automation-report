...
\begin{forest}
	...
	[{Chute du robot}, align=center, name=CR
		...
		[{Courant dans les\\fusibles trop élevés}, name=FUS]
		[{Erreur de la\\centrale inertielle}, name=CI]

	\node[anchor=west,align=left] 
	at ([xshift=-2cm]MS.west|-PDC) {Level 2\\Root cause};
	\node[anchor=west,align=left] 
	at ([xshift=-2cm]MS.west|-SS) {Level 1\\Error name};
\end{forest}
