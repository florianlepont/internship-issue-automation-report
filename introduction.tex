...
\begin{item}
	\item [Tête] 2 moteurs pour les mouvements de lacet (rotation selon l'axe $z$) et de tangage (rotation selon l'axe $y$)
	\item [bras] 4 moteurs répartis de la manière suivante: 
\end{item}
