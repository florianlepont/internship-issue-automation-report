...
Le robot Pepper est constitué de 20 moteurs lui offrant sa mobilité de :
\begin{description}
...
Pepper comporte également une multitude de capteurs. Certains d'entres-eux seront principalement afin de s'assurer du bon comportement des parties électroniques et mécaniques du robot et d'interagir avec celui-ci. 
