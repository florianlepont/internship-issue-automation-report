...
\subsection{Exemple d'analyse d'une}
...
\begin{figure}[h]
	\centering\includegraphics[height=7cm]{images/analse_1.png}
	\caption{Analyse d'}
	\label{fig:Répartition des actionneurs de Pepper}
\end{figure}

\begin{figure}[h]
	\centering\includegraphics[height=7cm]{images/analse_2.png}
	\caption{Répartition des actionneurs de Pepper}
	\label{fig:Répartition des actionneurs de Pepper}
\end{figure}

\begin{figure}[h]
	\centering\includegraphics[height=7cm]{images/analse_3.png}
	\caption{Répartition des actionneurs de Pepper}
	\label{fig:Répartition des actionneurs de Pepper}
\end{figure}
