...
\section{Presentation du produit}
...
\subsection{Présentation du Hardware Pepper}
\label{Introduction:Expression du besoin:Présentation du produit}
Afin de mieux cerner les différents problèmes techniques que peut rencontrer le robot, une description succincte de l'architecture mécanique et électronique de Pepper est donnée dans cette partie. 
