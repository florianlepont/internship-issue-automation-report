...
\begin{itemize}
	\item Lors du déroulement du Filtering test, le robot tombe à t = 16972 secondes, soit lorsqu'il réalise une séquence de mouvements particulière appelée "Heat Behavior". Les valeurs retournées par l'accéléromètre selon l'axe $Z$ attestent de cette chute. (c.f. figure \ref{fig:analyse d'une anomalie: accéléromètre})
