...
\begin{table}[h]
	\begin{tabular}{ | l | p{10cm} | }
		...
		\hline 
		Les boutons & 1 sur le buste, 3 bumpers sur la base du robot & Les bumpers permettent au robot de détecter si il rencontre un obstacle à proximité directe. Le bouton du buste permet quant à lui de 
		\hline 
